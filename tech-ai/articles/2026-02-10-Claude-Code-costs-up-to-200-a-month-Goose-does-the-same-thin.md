...
무료로 코드를 쓰는 AI, Goose가 등장한다. 저렴하지만 강력한 오픈소스 AI 개발 도구  Goose 는 사용자의 로컬 머신에서 작동하는 오픈소스 AI 코딩 에이전트로,  강력한 기능을 제공하며 무료로 이용 가능하다.  Goose는 Block(원래 Square)에서 개발되

**📰 [전체 기사 읽기 → society-now.com](https://www.society-now.com/sonow/article/ai/ai26021041/ai26021041-ai.html)**
